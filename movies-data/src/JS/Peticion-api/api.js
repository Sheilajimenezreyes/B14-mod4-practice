...
export async function searchMovie(word){
    try{
        const request = await fetch ('https://api.themoviedb.org/3/search/movie?query='+word+'&include_adult=false&language=en-US&page=1', {
            method: 'GET',
            headers:{
                Accept: "application/json",
                authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIzNDZjMGQ1YzRlZjJlZmZlNmRmYjdhYjc0OWY5MDc3YSIsIm5iZiI6MTc3NTkwODQ2OS4yOTEwMDAxLCJzdWIiOiI2OWRhMzY3NTg0Y2Q4Nzk3MDkxZDhmNDUiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.Fi_axX_hAoL-loX7RpBeNrsR3MlcFUZaqH31pYqQDtM"
...
export async function actors(id){
    try{
        const request = await fetch ("https://api.themoviedb.org/3/movie/"+id+"/credits?language=es-EU", {
            method: 'GET',
            headers:{
                Accept: "application/json",
                authorization: "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIzNDZjMGQ1YzRlZjJlZmZlNmRmYjdhYjc0OWY5MDc3YSIsIm5iZiI6MTc3NTkwODQ2OS4yOTEwMDAxLCJzdWIiOiI2OWRhMzY3NTg0Y2Q4Nzk3MDkxZDhmNDUiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.Fi_axX_hAoL-loX7RpBeNrsR3MlcFUZaqH31pYqQDtM"
